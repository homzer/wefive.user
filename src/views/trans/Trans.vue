...
&lt;!&ndash;    <div class="btn-update2"><span @click="Return">返回</span></div>&ndash;&gt;
  ...
  <div v-else-if="flag === 2" class="form">
    ...
    <div class="input-control" style="margin-top:80px">
      <input type="text" name="username" v-model="user.name1" placeholder="昵称" />
    </div>
    <div class="input-control">
      <input type="text" name="username" v-model="user.password1" placeholder="密码" />
    </div>
    <div class="input-control">
      <input type="text" name="username" v-model="user.tel1" placeholder="电话" />
    </div>
    <div class="input-control">
      <input type="text" name="username" v-model="user.cardId1" placeholder="身份证号" />
    </div>
